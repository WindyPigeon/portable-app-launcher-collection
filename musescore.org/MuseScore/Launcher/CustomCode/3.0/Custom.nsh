...
${SegmentPre}
    ${IfNot} ${FileExists} $DataDirectory\Preferences\MuseScore3.ini
        CreateDirectory $DataDirectory\Preferences

        FileOpen    $0  $DataDirectory\Preferences\MuseScore3.ini   w
        ...
        WriteINIStr $DataDirectory\Preferences\MuseScore3.ini   \
                application \
                paths\myPlugins \
