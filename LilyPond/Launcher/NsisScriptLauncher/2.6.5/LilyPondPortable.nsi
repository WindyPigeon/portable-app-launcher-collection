...
Section "Main"
    ...
    FoundProgramEXE:
        ...
        Rename "$USERPROFILEPATH\.fonts.cache-1" "$USERPROFILEPATH\.fonts.cache-1.BackupBy${NAME}"
    ...
    CleanupLilypondFontsCache:
        ...
        Rename "$USERPROFILEPATH\.fonts.cache-1" "$DATADIRECTORY\.fonts.cache-1"
        RMDir /r "$USERPROFILEPATH\.fonts.cache-1"

        Rename "$USERPROFILEPATH\.fonts.cache-1.BackupBy${NAME}" "$USERPROFILEPATH\.fonts.cache-1"
