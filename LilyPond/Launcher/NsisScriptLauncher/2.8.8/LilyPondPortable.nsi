...
Section "Main"
    ...
    FoundProgramEXE:
        ...
        Rename "$USERPROFILEPATH\.fontconfig" "$USERPROFILEPATH\.fontconfig.BackupBy${NAME}"
    ...
    CleanupLilypondFontsCache:
        ...
        Rename "$USERPROFILEPATH\.fontconfig" "$DATADIRECTORY\.fontconfig"
        RMDir /r "$USERPROFILEPATH\.fontconfig"

        Rename "$USERPROFILEPATH\.fontconfig.BackupBy${NAME}" "$USERPROFILEPATH\.fontconfig"
