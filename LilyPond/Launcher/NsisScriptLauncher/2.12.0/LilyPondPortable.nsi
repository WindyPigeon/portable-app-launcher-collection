...
Section "Main"
    ...
    FoundProgramEXE:
        ...
        Rename "$USERPROFILEPATH\.lilypond-fonts.cache-2" "$USERPROFILEPATH\.lilypond-fonts.cache-2.BackupBy${NAME}"
    ...
    CleanupLilypondFontsCache:
        ...
        Rename "$USERPROFILEPATH\.lilypond-fonts.cache-2" "$DATADIRECTORY\.lilypond-fonts.cache-2"
        RMDir /r "$USERPROFILEPATH\.lilypond-fonts.cache-2"

        Rename "$USERPROFILEPATH\.lilypond-fonts.cache-2.BackupBy${NAME}" "$USERPROFILEPATH\.lilypond-fonts.cache-2"
